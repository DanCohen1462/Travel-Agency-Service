    ...
    public class UsersController : Controller
    {
        ...
        public IActionResult MyTrips()
        {
            ...
            using (var conn = new SqlConnection(_connectionString))
            {
                ...
                // 🟢 תיקון: מחקתי את p.Image מהשאילתה כי העמודה לא קיימת
                string sql = @"
            SELECT 
                ...
                using (var cmd = new SqlCommand(sql, conn))
                {
                    ...
                    using (var reader = cmd.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            ...
                            // 🟢 תיקון: מכיוון שאין עמודת תמונה בדאטה בייס, ניתן תמונה קבועה ויפה
                            trip.ImageUrl = "https://images.unsplash.com/photo-1469854523086-cc02fe5d8800";
